...
def single_movie(movie_id):
    ...
    movie_details = {'details': query(details_command, holders, individual_movie_result),
                     ...
                     'similar_genres_by_genre':get_similar_rated_genres(genres),
                     'similar_genres_by_tag':get_similar_tagged_genres(tags_dict)
                      }
...
def get_similar_tagged_genres(tags_dict):
    ...
    return tagged_genres(nUsers, condition, tags)
