...
# def polarity(start, end)-> List[Dict]:
#     result = []
#     try:
#         connection = mysql.connector.connect(**config)
#         cursor = connection.cursor()
...
#         cursor.execute(command)
#         result = [{"title" : title, "release_year" : release_year, "polarity_index":polarity_index}  for title, release_year, polarity_index in cursor]
#     except mysql.connector.Error as err:
#             abort(500, err)
#     finally:
#         cursor.close()
